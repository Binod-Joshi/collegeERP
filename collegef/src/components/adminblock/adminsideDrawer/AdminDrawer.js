      ...
      <Box sx={{ display: "flex" }}>
                ...
                <ListItemButton component={Link} to="/showteachers">
                  <ListItemIcon>
                    <SupervisorAccountOutlinedIcon
                      color={
                        location.pathname.startsWith("/showteachers")
                          ? "primary"
                          : "inherit"
                      }
                    />
        ...
        <Box component="main" sx={styles.boxStyled}>
          ...
          <Routes>
            ...
            <Route
              path="/chooseaddteacher/:id"
              element={<ChooseAddTeacher />}
            />
            <Route
              path="/chooseaddstudent/:id"
              element={<ChooseAddStudent />}
            />
            <Route
              path="/particularcoursestudents/:id"
              element={<ParticularCourseStudents />}
            />
