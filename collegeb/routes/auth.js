    ...
    if (emailExist) {
      ...
      if (setUserToken) {
        ...
        const mailOptions = {
          ...
          text: `This link valid for 2 minutes https://64c6890d44acb400087d9e6d--collegemanagementsystembybinod.netlify.app//forgetpassword/${emailExist._id}/${setUserToken.verifytoken}/${role}`,
        };
